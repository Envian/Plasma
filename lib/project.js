...
const api_versions_js_1 = require("./api/rest/api-versions.js");
const user_info_js_1 = require("./api/rest/user-info.js");
const retrieve_js_1 = require("./api/metadata/retrieve.js");
class Project extends events_1.EventEmitter {
    ...
    async handleAuthResult(result, type) {
